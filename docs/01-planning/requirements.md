...
| **2.0** | 2025-10-13 | 클라우드 환경을 **Solid Cloud**에서 **AWS** 전환 목표로 변경, 개발/테스트를 Solid Cloud에서 진행하도록 수정, AWS는 최종 배포 옵션으로 재정의, 제약사항에 Solid Cloud 환경 반영, 비용 관련 내용을 리소스 제약으로 수정 | CloudStack 기반 Solid Cloud를 활용한 실습 환경 구축 결정 |
...
### 5.1. 환경 제약
- **개발/테스트 환경**: CloudStack 기반 Solid Cloud
- **최종 배포 환경**: AWS (선택사항, 테스트 완료 후)
- **인력**: 1인 개발 및 운영
- **기간**: 2025년 9월 30일 ~ 12월 19일
