...
| **Cluster 규모** | **멀티Node Cluster** | 프로덕션 수준 | 프로덕션 수준 | 프로덕션 수준 | 단일 Node | 실제 프로덕션과 유사한 환경. |
...
2. **실제 운영 환경 경험**:
   - 멀티Node Kubernetes Cluster (Master 1, Worker 2~3)
...
- Cluster 자체 관리 책임 (업그레이드, 백업, 보안 패치 등)
